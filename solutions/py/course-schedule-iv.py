...
if __name__ == '__main__':
    sol = Solution()
    assert sol.checkIfPrerequisite(numCourses=2, prerequisites=[[1, 0]],
                                   queries=[[0, 1], [1, 0]]) == [False, True]

    assert sol.checkIfPrerequisite(numCourses=2, prerequisites=[],
                                   queries=[[1, 0], [0, 1]]) == [False, False]

    assert sol.checkIfPrerequisite(numCourses=3, prerequisites=[[1, 2], [1, 0], [2, 0]],
                                   queries=
                                   [[1, 0], [1, 2]]) == [True, True]
