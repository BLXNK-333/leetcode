...
if __name__ == '__main__':
    sol = Solution()
    assert sol.removeAnagrams(words=["abba", "baba", "bbaa", "cd", "cd"]) == ["abba", "cd"]
    assert sol.removeAnagrams(words=["a", "b", "c", "d", "e"]) == ["a", "b", "c", "d", "e"]
    assert sol.removeAnagrams(words=["a", "b", "a"]) == ["a", "b", "a"]
