...
class Solution:
    def _check(self, lst: list):
        return len({d for d in lst if d}) == 1
...
if __name__ == '__main__':
    sol = Solution()
    assert sol.equalFrequency(word = "abcc") == 1
    assert sol.equalFrequency(word = "aazz") == 0
    assert sol.equalFrequency(word = "cccaa") == 1
    assert sol.equalFrequency(word = "bac") == 1
    assert sol.equalFrequency(word = "ddaccb") == 0
    assert sol.equalFrequency(word = "abbcc") == 1
