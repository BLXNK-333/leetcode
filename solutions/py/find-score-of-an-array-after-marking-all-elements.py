...
if __name__ == '__main__':
    sol = Solution()
    assert sol.findScore(nums=[2, 1, 3, 4, 5, 2]) == 7
    assert sol.findScore(nums=[2, 3, 5, 1, 3, 2]) == 5
    assert sol.findScore(
        [10, 44, 10, 8, 48, 30, 17, 38, 41, 27,
         16, 33, 45, 45, 34, 30, 22, 3, 42, 42]) == 212
