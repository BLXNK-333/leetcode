...
Find the largest value in nums. Let its index be i (0-indexed) and its value be largest. If
...
class Solution:
    def counter(self, array: [List[int]]) -> dict:
        d = {}
        for i in array:
            d[i] = d.get(i, 0) + 1
        return d
...
if __name__ == '__main__':
    sol = Solution()
    print(sol.reductionOperations([7,9,10,8,6,4,1,5,2,3]))
