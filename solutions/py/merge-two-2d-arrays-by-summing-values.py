...
the two arrays. If the id does not exist in one of the two arrays then its value in that array
...
if __name__ == '__main__':
    ...
    assert sol.mergeArrays(nums1=[[1, 2], [2, 3], [4, 5]], nums2=[[1, 4], [3, 2], [4, 1]]) == [[1, 6], [2, 3], [3, 2],
                                                                                               [4, 6]]
    assert sol.mergeArrays(nums1=[[2, 4], [3, 6], [5, 5]], nums2=[[1, 3], [4, 3]]) == [[1, 3], [2, 4], [3, 6], [4, 3],
                                                                                       [5, 5]]
