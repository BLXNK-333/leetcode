...
revisions 1 and 001 are considered equal. If a version number does not specify a revision at an
index, then treat the revision as 0. For example, version 1.0 is less than version 1.1 because
...
if __name__ == '__main__':
    ...
    assert sol.compareVersion(version1="1.2", version2="1.10") == -1
    assert sol.compareVersion(version1="1", version2="1.0.1") == -1
    assert sol.compareVersion(version1="1.1", version2="1") == 1
