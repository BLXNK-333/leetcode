...
The concatenation value of nums is initially equal to 0. Perform this operation
until nums becomes empty:
...
nums has only one element, so we pick 13 and add it to the concatenation value,
so it becomes equal to 673.
