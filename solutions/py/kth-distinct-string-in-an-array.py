...
if __name__ == '__main__':
    sol = Solution()
    assert sol.kthDistinct(arr = ["d","b","c","b","c","a"], k = 2) == "a"
    assert sol.kthDistinct(arr = ["aaa","aa","a"], k = 1) == "aaa"
    assert sol.kthDistinct(arr = ["a","b","a"], k = 3) == ""