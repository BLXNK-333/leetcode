...
if __name__ == '__main__':
    ...
    assert sol.removeKdigits(num="112", k=1) == "11"
    assert sol.removeKdigits(num="10001", k=1) == "1"
    assert sol.removeKdigits(num="100", k=1) == "0"
    assert sol.removeKdigits(num="12", k=1) == "1"
