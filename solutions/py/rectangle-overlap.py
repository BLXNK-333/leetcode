...
if __name__ == '__main__':
    sol = Solution()
    assert sol.isRectangleOverlap(rec1=[0, 0, 2, 2], rec2=[1, 1, 3, 3]) == True
    assert sol.isRectangleOverlap(rec1=[0, 0, 1, 1], rec2=[1, 0, 2, 1]) == False
    assert sol.isRectangleOverlap(rec1=[0, 0, 1, 1], rec2=[2, 2, 3, 3]) == False

    assert sol.isRectangleOverlap(rec1=[2, 17, 6, 20], rec2=[3, 8, 6, 20]) == True
    assert sol.isRectangleOverlap(rec1=[0, 0, 1, 1], rec2=[1, 0, 2, 1]) == False
    assert sol.isRectangleOverlap(rec1=[4, 4, 14, 7], rec2=[4, 3, 8, 8]) == True
