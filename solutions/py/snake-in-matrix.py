...
class Solution:
    def finalPositionOfSnake(self, n: int, commands: List[str]) -> int:
        ...
        i = counter.get("D", 0) - counter.get("U", 0)
        j = counter.get("R", 0) - counter.get("L", 0)
...
if __name__ == '__main__':
    ...
    assert sol.finalPositionOfSnake(n=2, commands=["RIGHT", "DOWN"]) == 3
    assert sol.finalPositionOfSnake(n=3, commands=["DOWN", "RIGHT", "UP"]) == 1
