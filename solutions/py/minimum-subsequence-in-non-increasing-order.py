...
which is not strictly greater than the sum of elements not included (14 = 4 + 4
+ 6). Therefore, the subsequence [7,6,7] is the minimal satisfying the
...
if __name__ == '__main__':
    sol = Solution()
    print(sol.minSubsequence(nums=[4, 3, 10, 9, 8]))
