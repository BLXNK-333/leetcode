...
class Solution:
    ...
    def countStudents(self, students: List[int], sandwiches: List[int]) -> int:
        stud_0, stud_1 = self.count_01(students)
        sand_0, sand_1 = self.count_01(sandwiches)
        ...
        while sandwiches:
            if students[0] == sandwiches[0]:
                ...
                if (sandwiches[0] == 0 and stud_0 == 0) or (sandwiches[0] == 1 and stud_1 == 0):
                    return len(students)
...
if __name__ == '__main__':
    ...
    assert sol.countStudents([1, 1, 1, 0, 0, 1], sandwiches=[1, 0, 0, 0, 1, 1]) == 3
