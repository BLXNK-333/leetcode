...
[2,4] and [4,4] have the smallest Manhattan distance from your current location, with a distance
of 1. [2,4] has the smallest index, so return 2.
...
if __name__ == '__main__':
    obj = Solution()
    print(obj.nearestValidPoint(x1=3, y1=4, points=[[1, 2], [3, 1], [2, 4], [2, 3], [4, 4]]))
