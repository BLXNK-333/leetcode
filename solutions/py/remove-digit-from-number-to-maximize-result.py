...
number such that the value of the resulting string in decimal form is
maximized. The test cases are generated such that digit occurs at least once in
number.
...
class Solution:
    def removeDigit(self, number: str, digit: str) -> str:
        ...
        for i in range(1, n):
            prev = number[i - 1]
            if prev == digit and number[i] > prev:
