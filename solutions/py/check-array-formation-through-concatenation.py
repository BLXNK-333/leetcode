...
if __name__ == '__main__':
    sol = Solution()
    assert sol.canFormArray(arr=[15, 88], pieces=[[88], [15]]) == True
    assert sol.canFormArray(arr=[49, 18, 16], pieces=[[16, 18, 49]]) == False
    assert sol.canFormArray(arr=[91, 4, 64, 78], pieces=[[78], [4, 64], [91]]) == True
