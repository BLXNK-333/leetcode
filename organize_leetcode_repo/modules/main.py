...
def main():
    ...
    actions = {
        ...
        "3": manager.remove_all_descriptions,
        "4": manager.show_invalid_task_names,
    }
    args = sys.argv[1:]
    ...
    if not args:
        ...
        try:
            choice = input(
                ...
                "2 - принудительно перезаписать все описания задач и обновить таблицу README.md\n"
                "3 - удалить все описания из файлов с задачами\n"
                "4 - показать неверные имена задач\n"
